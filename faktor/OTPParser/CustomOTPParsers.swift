...
let CUSTOM_PARSERS: [CustomOTPParser] = [
    CustomOTPParser(
        ...
        example: "123456 is the OTP for transaction of INR 1234.00 on your Kotak Bank Card 1234 at AMAZON PAY INDIA PRIVATET valid for 15 mins. DOtwNT SHARE OTP WITH ANYONE INCLUDING BANK OFFICIALS.",
    ...
    CustomOTPParser(
        ...
        canParseMessage: { message in
            let words = message.components(separatedBy: " ")
            return message.contains("Your verification code:") && words[3].replacingOccurrences(of: ".", with: "").isInt
        }, parseMessage: { message in
            let words = message.components(separatedBy: " ")
